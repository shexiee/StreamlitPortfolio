...
def show_projects():
    ...
    """)
    st.image("pictures/CRANVAS.jpg")  # Corrected the path
    st.markdown("<hr>", unsafe_allow_html=True)
    ...
    - Key technologies: React JS, Springboot
    """)
    st.image("pictures/CAMPUSEATS.png")  # Corrected the path
...
def show_certifications():
    ...
    st.image("pictures/EFAM.png")  # Corrected the path
...
Image1 = Image.open("pictures/PROFILE.jpg")  # Corrected the path

col1, col2 = st.columns([1, 3])

with col1:
    st.image(Image1, width=250)  # Used the Image1 object
